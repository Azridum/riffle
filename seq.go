...
// ([Seq.Collect], [Seq.First], [Seq.Reduce], [Seq.Fold]). When the consumer
// stops early, every stage stops too, so no element beyond the ones actually
// needed is ever processed.
//
